...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        MainWindow.resize(1042, 909)
        sizePolicy = QtWidgets.QSizePolicy(QtWidgets.QSizePolicy.Fixed, QtWidgets.QSizePolicy.Fixed)
        sizePolicy.setHorizontalStretch(0)
        sizePolicy.setVerticalStretch(0)
        sizePolicy.setHeightForWidth(MainWindow.sizePolicy().hasHeightForWidth())
        MainWindow.setSizePolicy(sizePolicy)
        MainWindow.setMinimumSize(QtCore.QSize(1042, 909))
        MainWindow.setMaximumSize(QtCore.QSize(1042, 909))
        ...
        self.button_revert = QtWidgets.QPushButton(self.widget)
        self.button_revert.setMinimumSize(QtCore.QSize(0, 30))
        self.button_revert.setFocusPolicy(QtCore.Qt.NoFocus)
        self.button_revert.setObjectName("button_revert")
        self.verticalLayout_7.addWidget(self.button_revert)
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.button_confirm.setText(_translate("MainWindow", "确认编辑"))
        self.button_revert.setText(_translate("MainWindow", "撤销编辑"))
        self.button_save.setText(_translate("MainWindow", "保存分割结果"))
